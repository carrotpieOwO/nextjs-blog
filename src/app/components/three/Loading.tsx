...
export default function Loading () {
    ...
    return (
        <Html position={new THREE.Vector3(-1.3, 1.7, 0)}>
            <div className="text-center mb-2">캐릭터 생성중...</div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-[60px] h-[60px] sm:w-[120px] sm:h-[120px]">
