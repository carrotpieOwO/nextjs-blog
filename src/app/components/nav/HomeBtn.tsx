...
export default function HomeBtn () {
    ...
    return (
        <Link href="/" onClick={ handleClick } className="relative inline-flex items-center justify-start px-6 py-1 overflow-hidden font-medium transition-all bg-white dark:bg-gray-800 rounded hover:bg-white group">
